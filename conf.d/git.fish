# Adapted from Oh My Zsh's git plugin (https://github.com/ohmyzsh/ohmyzsh/blob/0f2715b/plugins/git/git.plugin.zsh).
# Original source copyright (c) 2009-2022 Robby Russell and contributors,
# licensed under the MIT License (https://github.com/ohmyzsh/ohmyzsh/blob/0f2715b/LICENSE.txt).
